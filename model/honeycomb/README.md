...
Honeycomb credentials via vault expressions or plain values:
...
**v1 Configuration API**: datasets, triggers, boards, columns, derived-columns,
slos, recipients, markers, marker-settings, dataset-definitions, burn-alerts
