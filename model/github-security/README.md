...
GitHub automation models for [swamp](https://github.com/systeminit/swamp) —
manage repos, issues, pull requests, and members using the Octokit REST SDK.
Also includes `@bixu/github-security` for repository security auditing.
...
Audit repository security posture — secret scanning, Dependabot, code scanning,
and third-party security tool coverage.
